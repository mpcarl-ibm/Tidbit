...
$GLOBALS['dataTool']['Accounts']['billing_address_street'] = array('range'=>array('min'=>1, 'max'=>1500) ,'suffixlist' => array('last_name_array', 'streetTypes'), 'isQuoted'=>true);
$GLOBALS['dataTool']['Accounts']['shipping_address_street'] = $GLOBALS['dataTool']['Accounts']['billing_address_street'];
...
$GLOBALS['dataTool']['Accounts']['billing_address_postalcode'] = array('range'=>array('min'=>15000, 'max'=>99999), 'isQuoted'=>true);
$GLOBALS['dataTool']['Accounts']['shipping_address_postalcode'] = $GLOBALS['dataTool']['Accounts']['billing_address_postalcode'];
...
$GLOBALS['dataTool']['Accounts']['name'] = array('list'=>'last_name_array', 'prefixlist'=>array('companyPre'), 'suffixlist'=>array('companyExt'));
